...
- Codepoints outside WinAnsi (CJK, most non-Latin scripts) render as `?`. Color emoji render as bundled-font images, not `?`. Full non-Latin text lifts with TTF embedding, queued for v0.4.
